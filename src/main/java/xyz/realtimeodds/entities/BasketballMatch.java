...
public record BasketballMatch(
    ...
    @JsonCreator
    public static BasketballMatch of(
        ...
        return new BasketballMatch(id, competition, map, sportRegion, startDate, matchUrl, homeTeam, awayTeam);
    }

    @Override
    public SportEventKind kind() {
        return SportEventKind.BASKETBALL_MATCH;
    }
    ...
    public SportEvent withMarkets(Map<String, Market> newMarkets) {
        return new BasketballMatch(id, competition, newMarkets, sportRegion, startDate, matchUrl, homeTeam, awayTeam);
    }
}
