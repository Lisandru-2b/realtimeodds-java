...
public record BaseballMatch(
    ...
    @JsonCreator
    public static BaseballMatch of(
        ...
        return new BaseballMatch(id, competition, map, sportRegion, startDate, matchUrl, homeTeam, awayTeam);
    }

    @Override
    public SportEventKind kind() {
        return SportEventKind.BASEBALL_MATCH;
    }
    ...
    public SportEvent withMarkets(Map<String, Market> newMarkets) {
        return new BaseballMatch(id, competition, newMarkets, sportRegion, startDate, matchUrl, homeTeam, awayTeam);
    }
}
