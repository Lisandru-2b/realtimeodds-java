...
public record CricketMoneyline(
        String id,
        boolean isSynthetic,
    ...
    public CricketMoneyline { selections = Map.copyOf(selections); }

    @JsonCreator
    public static CricketMoneyline of(
        ...
        return new CricketMoneyline(id, isSynthetic, map, homeTeam, awayTeam);
    }
    ...
    @Override public MarketKind kind() { return MarketKind.CRICKET_MONEYLINE; }
    ...
    @Override public Market withSelections(Map<String, Selection> newSelections) {
        return new CricketMoneyline(id, isSynthetic, newSelections, homeTeam, awayTeam);
    }
}
