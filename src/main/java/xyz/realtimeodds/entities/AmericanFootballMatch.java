...
public record AmericanFootballMatch(
        String id,
        String competition,
    ...
    public AmericanFootballMatch {
        markets = Map.copyOf(markets);
    }

    @JsonCreator
    public static AmericanFootballMatch of(
        ...
        return new AmericanFootballMatch(id, competition, map, sportRegion, startDate, matchUrl, homeTeam, awayTeam);
    }

    @Override
    public SportEventKind kind() {
        return SportEventKind.AMERICAN_FOOTBALL_MATCH;
    }
    ...
    public SportEvent withMarkets(Map<String, Market> newMarkets) {
        return new AmericanFootballMatch(id, competition, newMarkets, sportRegion, startDate, matchUrl, homeTeam, awayTeam);
    }
}
