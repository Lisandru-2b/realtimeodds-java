...
public record RugbyLeagueHandicap(
        String id,
        boolean isSynthetic,
    ...
    public RugbyLeagueHandicap { selections = Map.copyOf(selections); }

    @JsonCreator
    public static RugbyLeagueHandicap of(
        ...
        return new RugbyLeagueHandicap(id, isSynthetic, map, homeTeam, awayTeam, period == null ? "full_match" : period, handicap);
    }
    ...
    @Override public MarketKind kind() { return MarketKind.RUGBY_LEAGUE_HANDICAP; }
    ...
    @Override public Market withSelections(Map<String, Selection> newSelections) {
        return new RugbyLeagueHandicap(id, isSynthetic, newSelections, homeTeam, awayTeam, period, handicap);
    }
}
