...
public record HockeyTotal(
    ...
    public HockeyTotal { selections = Map.copyOf(selections); }

    @JsonCreator
    public static HockeyTotal of(
        ...
        return new HockeyTotal(id, isSynthetic, map, homeTeam, awayTeam, period == null ? "full_match" : period, scope, cut);
    }
    ...
    @Override public MarketKind kind() { return MarketKind.HOCKEY_TOTAL; }
    ...
    @Override public Market withSelections(Map<String, Selection> newSelections) {
        return new HockeyTotal(id, isSynthetic, newSelections, homeTeam, awayTeam, period, scope, cut);
    }
}
