...
public record MmaFight(
    ...
    public static MmaFight of(
        ...
        return new MmaFight(id, competition, map, sportRegion, startDate, matchUrl, competitor1, competitor2);
    }

    @Override
    public SportEventKind kind() {
        return SportEventKind.MMA_FIGHT;
    }
    ...
    public SportEvent withMarkets(Map<String, Market> newMarkets) {
        return new MmaFight(id, competition, newMarkets, sportRegion, startDate, matchUrl, competitor1, competitor2);
    }
}
