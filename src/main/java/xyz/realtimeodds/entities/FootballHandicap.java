...
public record FootballHandicap(
        String id,
        boolean isSynthetic,
    ...
    public FootballHandicap { selections = Map.copyOf(selections); }

    @JsonCreator
    public static FootballHandicap of(
        ...
        return new FootballHandicap(id, isSynthetic, map, homeTeam, awayTeam, period == null ? "full_match" : period, handicap);
    }
    ...
    @Override public MarketKind kind() { return MarketKind.FOOTBALL_HANDICAP; }
    ...
    @Override public Market withSelections(Map<String, Selection> newSelections) {
        return new FootballHandicap(id, isSynthetic, newSelections, homeTeam, awayTeam, period, handicap);
    }
}
