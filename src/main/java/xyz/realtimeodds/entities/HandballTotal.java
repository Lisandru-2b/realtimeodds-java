...
public record HandballTotal(
    ...
    public HandballTotal { selections = Map.copyOf(selections); }

    @JsonCreator
    public static HandballTotal of(
        ...
        return new HandballTotal(id, isSynthetic, map, homeTeam, awayTeam, period == null ? "full_match" : period, scope, cut);
    }
    ...
    @Override public MarketKind kind() { return MarketKind.HANDBALL_TOTAL; }
    ...
    @Override public Market withSelections(Map<String, Selection> newSelections) {
        return new HandballTotal(id, isSynthetic, newSelections, homeTeam, awayTeam, period, scope, cut);
    }
}
