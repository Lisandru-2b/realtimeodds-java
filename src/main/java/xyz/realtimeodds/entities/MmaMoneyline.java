...
public record MmaMoneyline(
    ...
    public MmaMoneyline { selections = Map.copyOf(selections); }

    @JsonCreator
    public static MmaMoneyline of(
        ...
        return new MmaMoneyline(id, isSynthetic, map, competitor1, competitor2);
    }
    ...
    @Override public MarketKind kind() { return MarketKind.MMA_MONEYLINE; }
    ...
    @Override public Market withSelections(Map<String, Selection> newSelections) {
        return new MmaMoneyline(id, isSynthetic, newSelections, competitor1, competitor2);
    }
}
