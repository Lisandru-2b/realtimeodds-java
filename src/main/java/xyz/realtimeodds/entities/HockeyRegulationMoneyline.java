...
public record HockeyRegulationMoneyline(
        String id,
        boolean isSynthetic,
    ...
    public HockeyRegulationMoneyline { selections = Map.copyOf(selections); }

    @JsonCreator
    public static HockeyRegulationMoneyline of(
        ...
        return new HockeyRegulationMoneyline(id, isSynthetic, map, homeTeam, awayTeam);
    }
    ...
    @Override public MarketKind kind() { return MarketKind.HOCKEY_REGULATION_MONEYLINE; }
    ...
    @Override public Market withSelections(Map<String, Selection> newSelections) {
        return new HockeyRegulationMoneyline(id, isSynthetic, newSelections, homeTeam, awayTeam);
    }
}
