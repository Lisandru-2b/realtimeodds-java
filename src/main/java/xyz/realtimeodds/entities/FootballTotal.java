...
public record FootballTotal(
    ...
    public FootballTotal { selections = Map.copyOf(selections); }

    @JsonCreator
    public static FootballTotal of(
        ...
        return new FootballTotal(id, isSynthetic, map, homeTeam, awayTeam, period == null ? "full_match" : period, scope, cut);
    }
    ...
    @Override public MarketKind kind() { return MarketKind.FOOTBALL_TOTAL; }
    ...
    @Override public Market withSelections(Map<String, Selection> newSelections) {
        return new FootballTotal(id, isSynthetic, newSelections, homeTeam, awayTeam, period, scope, cut);
    }
}
