...
public record BaseballHandicap(
        String id,
        boolean isSynthetic,
    ...
    public BaseballHandicap { selections = Map.copyOf(selections); }

    @JsonCreator
    public static BaseballHandicap of(
        ...
        return new BaseballHandicap(id, isSynthetic, map, homeTeam, awayTeam, period == null ? "full_match" : period, handicap);
    }
    ...
    @Override public MarketKind kind() { return MarketKind.BASEBALL_HANDICAP; }
    ...
    @Override public Market withSelections(Map<String, Selection> newSelections) {
        return new BaseballHandicap(id, isSynthetic, newSelections, homeTeam, awayTeam, period, handicap);
    }
}
