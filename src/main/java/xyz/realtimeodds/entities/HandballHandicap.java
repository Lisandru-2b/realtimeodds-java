...
public record HandballHandicap(
        String id,
        boolean isSynthetic,
    ...
    public HandballHandicap { selections = Map.copyOf(selections); }

    @JsonCreator
    public static HandballHandicap of(
        ...
        return new HandballHandicap(id, isSynthetic, map, homeTeam, awayTeam, period == null ? "full_match" : period, handicap);
    }
    ...
    @Override public MarketKind kind() { return MarketKind.HANDBALL_HANDICAP; }
    ...
    @Override public Market withSelections(Map<String, Selection> newSelections) {
        return new HandballHandicap(id, isSynthetic, newSelections, homeTeam, awayTeam, period, handicap);
    }
}
