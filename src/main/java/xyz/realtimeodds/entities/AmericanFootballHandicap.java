...
public record AmericanFootballHandicap(
        String id,
        boolean isSynthetic,
    ...
    public AmericanFootballHandicap { selections = Map.copyOf(selections); }

    @JsonCreator
    public static AmericanFootballHandicap of(
        ...
        return new AmericanFootballHandicap(id, isSynthetic, map, homeTeam, awayTeam, period == null ? "full_match" : period, handicap);
    }
    ...
    @Override public MarketKind kind() { return MarketKind.AMERICAN_FOOTBALL_HANDICAP; }
    ...
    @Override public Market withSelections(Map<String, Selection> newSelections) {
        return new AmericanFootballHandicap(id, isSynthetic, newSelections, homeTeam, awayTeam, period, handicap);
    }
}
