...
public record RugbyLeagueMatch(
        String id,
        String competition,
    ...
    public RugbyLeagueMatch {
        markets = Map.copyOf(markets);
    }

    @JsonCreator
    public static RugbyLeagueMatch of(
        ...
        return new RugbyLeagueMatch(id, competition, map, sportRegion, startDate, matchUrl, homeTeam, awayTeam);
    }

    @Override
    public SportEventKind kind() {
        return SportEventKind.RUGBY_LEAGUE_MATCH;
    }
    ...
    public SportEvent withMarkets(Map<String, Market> newMarkets) {
        return new RugbyLeagueMatch(id, competition, newMarkets, sportRegion, startDate, matchUrl, homeTeam, awayTeam);
    }
}
