...
public record AmericanFootballTotal(
        String id,
        boolean isSynthetic,
    ...
    public AmericanFootballTotal { selections = Map.copyOf(selections); }

    @JsonCreator
    public static AmericanFootballTotal of(
        ...
        return new AmericanFootballTotal(id, isSynthetic, map, homeTeam, awayTeam, period == null ? "full_match" : period, scope, cut);
    }
    ...
    @Override public MarketKind kind() { return MarketKind.AMERICAN_FOOTBALL_TOTAL; }
    ...
    @Override public Market withSelections(Map<String, Selection> newSelections) {
        return new AmericanFootballTotal(id, isSynthetic, newSelections, homeTeam, awayTeam, period, scope, cut);
    }
}
