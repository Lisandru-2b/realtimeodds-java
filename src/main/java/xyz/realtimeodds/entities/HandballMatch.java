...
public record HandballMatch(
    ...
    @JsonCreator
    public static HandballMatch of(
        ...
        return new HandballMatch(id, competition, map, sportRegion, startDate, matchUrl, homeTeam, awayTeam);
    }

    @Override
    public SportEventKind kind() {
        return SportEventKind.HANDBALL_MATCH;
    }
    ...
    public SportEvent withMarkets(Map<String, Market> newMarkets) {
        return new HandballMatch(id, competition, newMarkets, sportRegion, startDate, matchUrl, homeTeam, awayTeam);
    }
}
