...
public record CricketMatch(
    ...
    public static CricketMatch of(
        ...
        return new CricketMatch(id, competition, map, sportRegion, startDate, matchUrl, homeTeam, awayTeam);
    }

    @Override
    public SportEventKind kind() {
        return SportEventKind.CRICKET_MATCH;
    }
    ...
    public SportEvent withMarkets(Map<String, Market> newMarkets) {
        return new CricketMatch(id, competition, newMarkets, sportRegion, startDate, matchUrl, homeTeam, awayTeam);
    }
}
