...
public record RugbyLeagueTotal(
        String id,
        boolean isSynthetic,
    ...
    public RugbyLeagueTotal { selections = Map.copyOf(selections); }

    @JsonCreator
    public static RugbyLeagueTotal of(
        ...
        return new RugbyLeagueTotal(id, isSynthetic, map, homeTeam, awayTeam, period == null ? "full_match" : period, scope, cut);
    }
    ...
    @Override public MarketKind kind() { return MarketKind.RUGBY_LEAGUE_TOTAL; }
    ...
    @Override public Market withSelections(Map<String, Selection> newSelections) {
        return new RugbyLeagueTotal(id, isSynthetic, newSelections, homeTeam, awayTeam, period, scope, cut);
    }
}
