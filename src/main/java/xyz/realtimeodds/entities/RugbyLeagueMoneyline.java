...
public record RugbyLeagueMoneyline(
        String id,
        boolean isSynthetic,
    ...
    public RugbyLeagueMoneyline { selections = Map.copyOf(selections); }

    @JsonCreator
    public static RugbyLeagueMoneyline of(
        ...
        return new RugbyLeagueMoneyline(id, isSynthetic, map, homeTeam, awayTeam, period == null ? "full_match" : period);
    }
    ...
    @Override public MarketKind kind() { return MarketKind.RUGBY_LEAGUE_MONEYLINE; }
    ...
    @Override public Market withSelections(Map<String, Selection> newSelections) {
        return new RugbyLeagueMoneyline(id, isSynthetic, newSelections, homeTeam, awayTeam, period);
    }
}
