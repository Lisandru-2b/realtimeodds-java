...
public record BaseballMoneyline(
        String id,
        boolean isSynthetic,
    ...
    public BaseballMoneyline { selections = Map.copyOf(selections); }

    @JsonCreator
    public static BaseballMoneyline of(
        ...
        return new BaseballMoneyline(id, isSynthetic, map, homeTeam, awayTeam, period == null ? "full_match" : period);
    }
    ...
    @Override public MarketKind kind() { return MarketKind.BASEBALL_MONEYLINE; }
    ...
    @Override public Market withSelections(Map<String, Selection> newSelections) {
        return new BaseballMoneyline(id, isSynthetic, newSelections, homeTeam, awayTeam, period);
    }
}
